...
class dataRecord():
    """Cet objet stock et gère l'enregistrement des données, pour générer des
    fichiers CSV. On surcharge la classe logging. En effet, c'est un loggeur,
    mais qui continent d'autres choses avec
    """
